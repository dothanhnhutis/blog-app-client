...
const ManagerPage = () => {
  return (
    <div>
      <div className="bg-background h-5">bg-background</div>
      <div className="bg-foreground h-5">bg-foreground</div>
      <div className="bg-primary h-5">bg-primary</div>
      <div className="bg-primary-foreground h-5">bg-primary-foreground</div>
